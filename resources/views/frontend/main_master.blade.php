                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <ul class="about__icons__wrap">
                            ...
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/illustrator_light.png') }}"
                                    alt="Illustrator">
                            ...
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/photoshop_light.png') }}"
                                    alt="Photoshop">
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            ...
                            <div class="services__content">
                                <div class="services__icon">
                                    <img class="light"
                                        src="{{ asset('frontend/ssets/img/icons/services_light_icon04.png') }}a"
                                        alt="">
                                    <img class="dark"
                ...
                <div class="row work__process__wrap">
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/wp_light_icon01.png') }}"
                                    alt="">
                    ...
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/wp_light_icon02.png') }}"
                                    alt="">
                    ...
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/wp_light_icon03.png') }}"
                                    alt="">
                    ...
                    <div class="col">
                        <div class="work__process__item">
                            ...
                            <div class="work__process__icon">
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/wp_light_icon04.png') }}"
                                    alt="">
                        ...
                        <div class="row gx-0 justify-content-center">
                            <div class="col">
                                <div class="portfolio__active">
                                    ...
                                    <div class="portfolio__item">
                                        <div class="portfolio__thumb">
                                            <img src="{{ asset('frontend/assets/img/portfolio/portfolio_img05.jpg') }}x"
                                                alt="">
                                        </div>
                                        <div class="portfolio__overlay__content">
                                            <span>UX/UI Design</span>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <ul class="partner__logo__wrap">
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/partner_light01.png') }}"
                                    alt="">
                            ...
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/partner_light02.png') }}"
                                    alt="">
                            ...
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/partner_light03.png') }}"
                                    alt="">
                            ...
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/partner_light04.png') }}"
                                    alt="">
                            ...
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/partner_light05.png') }}"
                                    alt="">
                            ...
                            <li>
                                <img class="light"
                                    src="{{ asset('frontend/assets/img/icons/partner_light06.png') }}"
                                    alt="">
